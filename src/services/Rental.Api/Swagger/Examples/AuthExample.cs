...
namespace Rental.Api.Swagger.Examples
{
    ...
    public class RefreshTokenRequestExamplo : IExamplesProvider<RefreshTokenRequest>
    {
        public RefreshTokenRequest GetExamples() => new RefreshTokenRequest
        {
            RefreshToken = "3f9d8a23-6a1c-47e8-b872-410f5e5d45d3"
        };
    }

    public class RefreshTokenResponseExamplo : IExamplesProvider<ApiResponse>
    {
        public ApiResponse GetExamples() => new ApiResponse(
            success: true,
            messages: new[] { AuthMessages.Refresh_Token_Generated_Successfully },
